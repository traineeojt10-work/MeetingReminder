...
function initEvent(event) {
  ...
  const eventSubjectElement = eventElement.querySelector("[data-event-subject]");
  const eventTypeElement = eventElement.querySelector("[data-event-type]");
  ...
  eventSubjectElement.textContent = event.subject_name;
  eventTypeElement.textContent = event.event_type;

...
function fillEventDetailsDialog(parent, event) {
  ...
  const subjectElement = eventDetailsElement.querySelector("#subject");
  const eventTypeElement = eventDetailsElement.querySelector("#the_event_type");
  ...
  subjectElement.textContent = event.subject_name;
